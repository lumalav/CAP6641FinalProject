...
def main():
    ...
    run_parser.add_argument("--encoder",
                            ...
                            default='lstm')
    run_parser.add_argument("--task", default='mr')
    ...
    for task in tasks:
        ...
        for seed in seed_list:
            ...
            if task == 'MNLI-mm':
                data_dir = os.path.join('BadPrompt','data', 'k-shot', 'MNLI', data_split)
            elif task == 'RTE-glue':
                data_dir = os.path.join('BadPrompt','data', 'k-shot', 'RTE', data_split)
            else:
                data_dir = os.path.join('BadPrompt','data', 'k-shot', task, data_split)
