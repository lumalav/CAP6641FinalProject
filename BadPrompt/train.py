        ...
        for iteration in range(args.pet_repetitions):
            ...
            if args.do_train:
                if not args.two_stage_train:
                    ...
                    with open(os.path.join(pattern_iter_output_dir, 'results.json'), 'w', encoding='utf8') as fh:
                    ...
                    with open(os.path.join(pattern_iter_output_dir, 'results_stage1.json'), 'w', encoding='utf8') as fh:
                        json.dump(results_dict, fh)
